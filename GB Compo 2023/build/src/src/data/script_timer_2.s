...
___bank_script_timer_2 = 255
.globl ___bank_script_timer_2
...
_script_timer_2::
        ...
        ; Input Script Attach
        VM_CONTEXT_PREPARE      3, ___bank_script_input_21, _script_input_21
...
1$:
        ...
        ; Input Script Attach
        VM_CONTEXT_PREPARE      3, ___bank_script_input_22, _script_input_22
        VM_INPUT_ATTACH         32, ^/(3 | .OVERRIDE_DEFAULT)/
...
3$:
        ...
        ; Input Script Attach
        VM_CONTEXT_PREPARE      3, ___bank_script_input_23, _script_input_23
        VM_INPUT_ATTACH         32, ^/(3 | .OVERRIDE_DEFAULT)/
...
5$:
        ...
        ; Input Script Attach
        VM_CONTEXT_PREPARE      3, ___bank_script_input_24, _script_input_24
        VM_INPUT_ATTACH         32, ^/(3 | .OVERRIDE_DEFAULT)/
...
7$:
        ...
        ; Input Script Attach
        VM_CONTEXT_PREPARE      3, ___bank_script_input_25, _script_input_25
        VM_INPUT_ATTACH         32, ^/(3 | .OVERRIDE_DEFAULT)/
...
9$:
        ...
        ; Input Script Attach
        VM_CONTEXT_PREPARE      3, ___bank_script_input_26, _script_input_26
        VM_INPUT_ATTACH         32, ^/(3 | .OVERRIDE_DEFAULT)/
