...
.LOCAL_TMP2_CAMERA_SHAKE_ARGS = -7
.LOCAL_TMP3_OTHER_ACTOR = -7
.LOCAL_TMP4_OTHER_ACTOR = -7
.LOCAL_TMP5_OTHER_ACTOR = -7
.LOCAL_TMP6_WAIT_ARGS = -7
...
_script_8::
        ...
        VM_ACTOR_SET_MOVE_SPEED .LOCAL_ACTOR, 112
        ...
        ; Camera Shake
        VM_SET_CONST            .LOCAL_TMP2_CAMERA_SHAKE_ARGS, 1
        VM_SET_CONST            ^/(.LOCAL_TMP2_CAMERA_SHAKE_ARGS + 1)/, .CAMERA_SHAKE_Y
        ...
        VM_ACTOR_GET_POS        .LOCAL_ACTOR
        VM_SET_CONST            .LOCAL_TMP4_OTHER_ACTOR, 0
        VM_ACTOR_GET_POS        .LOCAL_TMP4_OTHER_ACTOR
        VM_RPN
            .R_REF      ^/(.LOCAL_TMP4_OTHER_ACTOR + 1)/
            .R_INT16    128
            .R_OPERATOR .DIV
            .R_REF      ^/(.LOCAL_ACTOR + 1)/
            .R_INT16    128
...
3$:
        ...
        ; If Actor .LTE 3 tiles from Actor
        VM_ACTOR_GET_POS        .LOCAL_ACTOR
        VM_SET_CONST            .LOCAL_TMP5_OTHER_ACTOR, 0
        VM_ACTOR_GET_POS        .LOCAL_TMP5_OTHER_ACTOR
        VM_RPN
            .R_REF      ^/(.LOCAL_TMP5_OTHER_ACTOR + 1)/
            .R_INT16    128
            .R_OPERATOR .DIV
            .R_REF      ^/(.LOCAL_ACTOR + 1)/
            .R_INT16    128
            ...
            .R_OPERATOR .SUB
            .R_OPERATOR .MUL
            .R_REF      ^/(.LOCAL_TMP5_OTHER_ACTOR + 2)/
            .R_INT16    128
            .R_OPERATOR .DIV
            .R_REF      ^/(.LOCAL_ACTOR + 2)/
            .R_INT16    128
...
5$:
        ...
        ; Wait N Frames
        VM_SET_CONST            .LOCAL_TMP6_WAIT_ARGS, 18
